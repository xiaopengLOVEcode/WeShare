...
/// 获取原始顺序的所有联系人的闭包
public typealias AddressBookArrayClosure = (_ addressBookArray: [PPPersonModel]) -> Void
/// 获取按A~Z顺序排列的所有联系人的闭包
public typealias AddressBookDictClosure = (_ addressBookDict: [String: [PPPersonModel]], _ nameKeys: [String]) -> Void

public class PPGetAddressBook {
    /**
        ...
        queue.async {
            ...
            PPAddressBookHandle().getAddressBookDataSource(personModel: { model in
                ...
                if addressBookDict[firstLetterString] != nil {
                    ...
                    var arrGroupNames:[PPPersonModel] = []
